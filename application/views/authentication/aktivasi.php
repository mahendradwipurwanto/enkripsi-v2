<div class="row">
	<div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
		...
		<div class="card card-primary">
			...
			<div class="card-body">
				<form action="<?= site_url('authentication/aktivasi_akun');?>" method="POST">
					<h6 class="font-weight-light">Masukan kode aktivasi Anda. Cek kotak masuk atau spam folder email
						Anda.</h6>
					<div class="form-group">
						<input id="text" type="number" class="form-control" name="kode_aktivasi" tabindex="1" required
							autofocus>
					</div>
